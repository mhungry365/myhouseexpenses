    ...
    <div style={{fontFamily:"'Inter',system-ui,sans-serif",minHeight:"100vh",background:"#f4f4f0",color:"#0f172a",position:"relative",paddingBottom:80}}>
      ...
      <div style={{background:"#f4f4f0",padding:"14px 20px",display:"flex",alignItems:"center",justifyContent:"space-between",maxWidth:900,margin:"0 auto"}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:8}}>
          <button onClick={()=>{const d=document.body;d.style.filter=d.style.filter?"":"invert(1) hue-rotate(180deg)";}} title="Toggle theme" style={{width:36,height:36,borderRadius:99,border:"1.5px solid #e2e8f0",background:"white",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",fontSize:16}}>🌓</button>
